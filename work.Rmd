...
.tocify::before {background-image: url(`r params$logo_url`); margin-bottom: 2rem; display: inline-block; content: ""; width: 100%; height: 100px; background-size: 150px; background-position: center; background-repeat: no-repeat; display: `r ifelse(is.character(params$logo_url), "inherit", "none")`}
.tocify:nth-child(1) ul:nth-child(1)::before {content: "`r params$title`"; padding-left: .25rem; padding-right: .5rem; display: inline-block;}
